...
<?php
    ...
    if(isset($_GET["idProduto"])){
        ...
        $res = mysqli_query($link, $exibirProduto); //Executa o comando de listagem
        ...
        if($totalProdutos > 0){
            ...
            <div class='row text-center'>";
                ...
                if($registro = mysqli_fetch_assoc($res)){
                    ...
                    $valorProduto     = $registro["precoProduto"];
                    ...
                    <div class="d-flex justify-content-center mb-3">
                        ...
                        <div class="card" style="width:40%; border-style:none;">
                            ...
                            <div class="card-body">
                                ...
                                <?php
                                    session_start();
                                    $tipoUsuario = $_SESSION['tipoCliente'];
                                    if($tipoUsuario == "administrador"){
                                        ...
                                        if(isset($_SESSION['logado']) && $_SESSION['logado'] === true){
                                            ...
                                            echo "<a href='formLogin.php' class='btn btn-danger'>Faça Login para realizar o seu Pedido</a>";
                                        }
