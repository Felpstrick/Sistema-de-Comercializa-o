...
<?php
    ...
    if($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        if($tudoCerto){
            $sqlUpdate = "UPDATE clientes SET fotoCliente='$fotoCliente', nomeCliente='$nomeCliente', cpfCliente='$cpfCliente', telefoneCliente='$telefoneCliente', emailCliente ='$emailCliente', senhaCliente ='$senhaCliente' WHERE idCliente='$idCliente'";
            $result = $link->query($sqlUpdate);
            if($result){
                echo "<div class='alert alert-success text-center'><strong>Cliente</strong> alterado(a) com sucesso!</div>";
                ...
                echo "<div class='alert alert-danger'>Erro ao tentar alterar <strong>CLIENTE</strong>!</div>" . mysqli_error($link);
            }
        }
